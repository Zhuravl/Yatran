...
public class InfoBarPanel extends JPanel {
    ...
    private void GUI() {
        ...
        keyboardField.setName("keyboardField");
        ...
        scoresLabel.setName("scoresLabel");
        ...
        mistakesLabel.setName("mistakesLabel");
        ...
        mistakesBar.setName("mistakesBar");
